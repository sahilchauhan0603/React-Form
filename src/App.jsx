...
const App = () => {
  ...
  return (
    <div className="w-full md:max-w-[50%] mx-auto shadow p-8 border bg-purple-200">
      <form className="space-y-2" onSubmit={submitHandler}>

        <label htmlFor="firstName" className="text-red-900 leading-6 text-sm font-medium">
          First Name <br />
        </label>
        <input
          type="text"
        ...
        <label className="text-red-900 leading-6 text-sm font-medium">
          Last Name <br />
          <input
            type="text"
            onChange={changeHandler}
        ...
        <label
          htmlFor=""
          className="text-red-900 leading-6 text-sm font-medium"
        >
          Street address <br />
          <input
            type="text"
        ...
        <fieldset className="mb-1">
          <legend className="text-sm font-semibold leading-6 text-red-900">By Email</legend>
          <br />
        ...
        <fieldset className="mt-10">
          <legend className="text-sm font-semibold leading-6 text-red-900">Push Notification</legend>
